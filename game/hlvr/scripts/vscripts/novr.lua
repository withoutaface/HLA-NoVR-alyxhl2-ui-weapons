if GlobalSys:CommandLineCheck("-novr") then
    ...
    player_spawn_ev = ListenToGameEvent('player_activate', function(info)
        ...
        if GetMapName() == "startup" then
            ...
            SendToConsole("ent_create game_text { targetname text_resin effect 2 spawnflags 1 color \"236 193 39\" color2 \"92 107 192\" fadein 0 fadeout 0.15 fxtime 0.25 holdtime 5 x 0.02 y -0.16 }")
